...
namespace MathAdminApp.Presentacion
{
    public class FormPreguntaDetalle : Form
    {
        ...
        private void InicializarComponentes()
        {
            ...
            btnAgregarRespuesta = CrearBoton("Agregar respuesta", Color.FromArgb(66, 133, 244), 40, 560, 220);
            btnAgregarRespuesta.Click += (s, e) => dgvRespuestas.Rows.Add(string.Empty, false);

            btnQuitarRespuesta = CrearBoton("Quitar respuesta", Color.FromArgb(255, 120, 70), 280, 560, 220);
            btnQuitarRespuesta.Click += BtnQuitarRespuesta_Click;

            btnGuardar = CrearBoton("Guardar", Color.FromArgb(50, 120, 255), 245, 625, 170);
            btnGuardar.Click += BtnGuardar_Click;

            btnCancelar = CrearBoton("Cancelar", Color.FromArgb(255, 80, 120), 445, 625, 170);
