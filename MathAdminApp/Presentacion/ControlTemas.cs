...
namespace MathAdminApp.Presentacion
{
    public partial class ControlTemas : UserControl
    {
        ...
        public ControlTemas(Usuario usuarioActual)
        {
        ...
        private void InicializarUI()
        {
            ...
            {
                Text = "Administra los temas registrados",
            ...
            btnEliminar.Location = new Point(400, 123);
            ...
            btnExportar.Location = new Point(610, 123);
        ...
        private void CargarFiltroProyectos()
        {
            try
            {
                ...
                var proyectos = _proyectoBLL.ObtenerVisibles(_usuarioActual);
        ...
        private void CargarTemas(int idProyecto = 0)
        {
            try
            {
                ...
                List<Tema> temas = idProyecto == 0
                    ? _temaBLL.ObtenerVisibles(_usuarioActual)
                ...
                foreach (var t in temas)
                    dgvTemas.Rows.Add(
                        ...
                        t.Nombre,
                        t.Descripcion,
                        ObtenerNombreProyecto(t.IdProyecto)
                    );
            }
            catch (Exception ex)
            {
        ...
        {
            int idProyecto = cmbFiltroProyecto.SelectedItem is ProyectoItem item
                ? item.Id
                : 0;
        ...
        {
            ExportadorExcel.Exportar(dgvTemas, "temas");
        }
        ...
        {
            var form = new FormTemaDetalle(null, _usuarioActual);
        ...
        private void BtnEditar_Click(object? sender, EventArgs e)
        {
            ...
            var tema = new Tema
            {
                ...
                IdProyecto = ObtenerIdProyecto(proyecto)
            };

            var form = new FormTemaDetalle(tema, _usuarioActual);
        ...
        {
            var proyecto = _proyectoBLL.ObtenerPorId(idProyecto);
            return proyecto?.nombre ?? string.Empty;
        }

        private int ObtenerIdProyecto(string nombreProyecto)
        {
            return _proyectoBLL.ObtenerVisibles(_usuarioActual)
                .FirstOrDefault(p => p.nombre == nombreProyecto)
                ?.idProyecto ?? 0;
        }
    }
}
