...
namespace MathAdminApp.Presentacion
{
    ...
    public class ControlExamenes : UserControl
    {
        ...
        private void InicializarComponentes()
        {
            ...
            dgvExamenes.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(156, 39, 176);
            ...
            dgvExamenes.DefaultCellStyle.SelectionBackColor = Color.FromArgb(220, 200, 235);
